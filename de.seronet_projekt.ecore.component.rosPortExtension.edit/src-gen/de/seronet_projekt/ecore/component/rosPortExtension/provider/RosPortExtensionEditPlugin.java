...
import rosInterfacesPool.provider.RosInterfacesPoolEditPlugin;

/**
 * This is the central singleton for the RosPortExtension edit plugin.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public final class RosPortExtensionEditPlugin extends EMFPlugin {
	/**
	 ...
	 * @generated
	 */
	public static final RosPortExtensionEditPlugin INSTANCE = new RosPortExtensionEditPlugin();
	 ...
	 * @generated
	 */
	public RosPortExtensionEditPlugin() {
		super(new ResourceLocator[] { BasicAttributesEditPlugin.INSTANCE, CommunicationObjectEditPlugin.INSTANCE,
				...
				ParameterDefinitionEditPlugin.INSTANCE, RosInterfacesPoolEditPlugin.INSTANCE,
